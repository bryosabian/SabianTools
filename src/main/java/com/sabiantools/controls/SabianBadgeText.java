 ...
 * @author Jeff Gilfelt
 */
public class SabianBadgeText extends TextView {
    ...
    public SabianBadgeText(Context context) {
        this(context, (AttributeSet) null, android.R.attr.textViewStyle);
    }

    public SabianBadgeText(Context context, AttributeSet attrs) {
     ...
     * Constructor -
     * <p/>
     * create a new SabianBadgeText instance attached to a target {@link View}.
     *
     * @param context context for this view.
     * @param target  the View to attach the badge to.
     */
    public SabianBadgeText(Context context, View target) {
     ...
     * Constructor -
     * <p/>
     * create a new SabianBadgeText instance attached to a target {@link TabWidget}
     ...
     */
    public SabianBadgeText(Context context, TabWidget target, int index) {
        this(context, null, android.R.attr.textViewStyle, target, index);
    }

    public SabianBadgeText(Context context, AttributeSet attrs, int defStyle) {
        this(context, attrs, defStyle, null, 0);
    }

    public SabianBadgeText(Context context, AttributeSet attrs, int defStyle, View target, int tabIndex) {
