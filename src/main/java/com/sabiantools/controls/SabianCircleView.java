 ...
 */
public class SabianCircleView extends View {
    ...
    public SabianCircleView(Context context) {
        super(context);
        init(null, 0);
    }

    public SabianCircleView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs, 0);
    }

    public SabianCircleView(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(AttributeSet attrs, int defStyle) {
        final TypedArray a = getContext().obtainStyledAttributes(
                attrs, R.styleable.SabianCircleView, defStyle, 0);

        if(a.hasValue(R.styleable.SabianCircleView_sc_titleText)){
            mTitleText = a.getString(R.styleable.SabianCircleView_sc_titleText);
        }

        if(a.hasValue(R.styleable.SabianCircleView_sc_subtitleText)){
            mSubtitleText = a.getString(R.styleable.SabianCircleView_sc_subtitleText);
        }

        mTitleColor = a.getColor(R.styleable.SabianCircleView_sc_titleColor,DEFAULT_TITLE_COLOR);
        mSubtitleColor = a.getColor(R.styleable.SabianCircleView_sc_subtitleColor,DEFAULT_SUBTITLE_COLOR);
        mBackgroundColor = a.getColor(R.styleable.SabianCircleView_sc_backgroundColorValue,DEFAULT_BACKGROUND_COLOR);
        mStrokeColor = a.getColor(R.styleable.SabianCircleView_sc_strokeColorValue,DEFAULT_STROKE_COLOR);
        mFillColor = a.getColor(R.styleable.SabianCircleView_sc_fillColor,DEFAULT_FILL_COLOR);

        mTitleSize = a.getDimension(R.styleable.SabianCircleView_sc_titleSize,DEFAULT_TITLE_SIZE);
        mSubtitleSize = a.getDimension(R.styleable.SabianCircleView_sc_subtitleSize,DEFAULT_SUBTITLE_SIZE);

        mStrokeWidth = a.getFloat(R.styleable.SabianCircleView_sc_strokeWidthSize,DEFAULT_STROKE_WIDTH);
        mFillRadius = a.getFloat(R.styleable.SabianCircleView_sc_fillRadius,DEFAULT_FILL_RADIUS);
